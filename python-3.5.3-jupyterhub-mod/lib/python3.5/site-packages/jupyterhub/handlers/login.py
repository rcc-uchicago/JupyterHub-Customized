    ...
    def get(self):
        ...
        if user:
            if not next_url:
                ...
                # JHS MM WE ADDED THIS ELSE CONDITION: 
                next_url = "/user/" + user.name  + next_url or self.hub.server.base_url
    ...
    def post(self):
        ...
        if username:
            ...
            if not next_url.startswith('/'):
                next_url = ''
            next_url = "/user/" + username  + next_url or self.hub.server.base_url
#orig       next_url = next_url or self.hub.server.base_url
